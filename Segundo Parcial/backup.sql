...
--
-- Temporary view structure for view `frag1conductor`
--

DROP TABLE IF EXISTS `frag1conductor`;
/*!50001 DROP VIEW IF EXISTS `frag1conductor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag1conductor` AS SELECT 
 1 AS `conductorId`,
 1 AS `nombre`,
 1 AS `numeroLicencia`,
...
--
-- Temporary view structure for view `frag1documento`
--

DROP TABLE IF EXISTS `frag1documento`;
/*!50001 DROP VIEW IF EXISTS `frag1documento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag1documento` AS SELECT 
 1 AS `documentoId`,
 1 AS `vehiculoId`,
 1 AS `tipo`,
...
--
-- Temporary view structure for view `frag1mantenimiento`
--

DROP TABLE IF EXISTS `frag1mantenimiento`;
/*!50001 DROP VIEW IF EXISTS `frag1mantenimiento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag1mantenimiento` AS SELECT 
...
--
-- Temporary view structure for view `frag1rutas`
--

DROP TABLE IF EXISTS `frag1rutas`;
/*!50001 DROP VIEW IF EXISTS `frag1rutas`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag1rutas` AS SELECT 
 1 AS `rutaId`,
 1 AS `vehiculoId`,
 1 AS `conductorId`,
 1 AS `horaInicio`,
...
--
-- Temporary view structure for view `frag1vehiculo`
--

DROP TABLE IF EXISTS `frag1vehiculo`;
/*!50001 DROP VIEW IF EXISTS `frag1vehiculo`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag1vehiculo` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `flotillaId`,
 1 AS `tipo`,
 1 AS `modelo`,
...
--
-- Temporary view structure for view `frag2conductor`
--

DROP TABLE IF EXISTS `frag2conductor`;
/*!50001 DROP VIEW IF EXISTS `frag2conductor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag2conductor` AS SELECT 
 1 AS `conductorId`,
 1 AS `nombre`,
 1 AS `numeroLicencia`,
 1 AS `vencimientoLicencia`,
...
--
-- Temporary view structure for view `frag2documento`
--

DROP TABLE IF EXISTS `frag2documento`;
/*!50001 DROP VIEW IF EXISTS `frag2documento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag2documento` AS SELECT 
 1 AS `documentoId`,
 1 AS `vehiculoId`,
 1 AS `tipo`,
 1 AS `fechaVencimiento`,
...
--
-- Temporary view structure for view `frag2mantenimiento`
--

DROP TABLE IF EXISTS `frag2mantenimiento`;
/*!50001 DROP VIEW IF EXISTS `frag2mantenimiento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag2mantenimiento` AS SELECT 
 1 AS `mantenimientoId`,
 1 AS `vehiculoId`,
 1 AS `fechaServicio`,
 1 AS `tipoServicio`,
...
--
-- Temporary view structure for view `frag2rutas`
--

DROP TABLE IF EXISTS `frag2rutas`;
/*!50001 DROP VIEW IF EXISTS `frag2rutas`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag2rutas` AS SELECT 
 1 AS `rutaId`,
 1 AS `vehiculoId`,
 1 AS `conductorId`,
 1 AS `horaInicio`,
...
--
-- Temporary view structure for view `frag2vehiculo`
--

DROP TABLE IF EXISTS `frag2vehiculo`;
/*!50001 DROP VIEW IF EXISTS `frag2vehiculo`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag2vehiculo` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `flotillaId`,
 1 AS `tipo`,
 1 AS `modelo`,
...
--
-- Temporary view structure for view `frag3documento`
--

DROP TABLE IF EXISTS `frag3documento`;
/*!50001 DROP VIEW IF EXISTS `frag3documento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `frag3documento` AS SELECT 
 1 AS `documentoId`,
 1 AS `vehiculoId`,
 1 AS `tipo`,
 1 AS `fechaVencimiento`,
...
--
-- Temporary view structure for view `rutaconductor`
--

DROP TABLE IF EXISTS `rutaconductor`;
/*!50001 DROP VIEW IF EXISTS `rutaconductor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rutaconductor` AS SELECT 
 1 AS `ubicacionInicio`,
 1 AS `ubicacionFin`,
 1 AS `estado`,
 1 AS `distancia`,
...
--
-- Temporary view structure for view `rutavehiculo`
--

DROP TABLE IF EXISTS `rutavehiculo`;
/*!50001 DROP VIEW IF EXISTS `rutavehiculo`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rutavehiculo` AS SELECT 
 1 AS `ubicacionInicio`,
 1 AS `ubicacionFin`,
 1 AS `estado`,
 1 AS `distancia`,
...
--
-- Temporary view structure for view `vehiculocombustible`
--

DROP TABLE IF EXISTS `vehiculocombustible`;
/*!50001 DROP VIEW IF EXISTS `vehiculocombustible`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculocombustible` AS SELECT 
...
--
-- Temporary view structure for view `vehiculodocumento`
--

DROP TABLE IF EXISTS `vehiculodocumento`;
/*!50001 DROP VIEW IF EXISTS `vehiculodocumento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculodocumento` AS SELECT 
 1 AS `fechaVencimiento`,
 1 AS `tipo`,
 1 AS `modelo`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vehiculomantenimiento`
--

DROP TABLE IF EXISTS `vehiculomantenimiento`;
/*!50001 DROP VIEW IF EXISTS `vehiculomantenimiento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculomantenimiento` AS SELECT 
 1 AS `fechaServicio`,
 1 AS `descripcion`,
 1 AS `costo`,
 1 AS `modelo`*/;
...
--
-- Final view structure for view `frag1conductor`
--
...
/*!50001 VIEW `frag1conductor` AS select `conductor`.`conductorId` AS `conductorId`,`conductor`.`nombre` AS `nombre`,`conductor`.`numeroLicencia` AS `numeroLicencia`,`conductor`.`vencimientoLicencia` AS `vencimientoLicencia`,`conductor`.`estado` AS `estado` from `conductor` where (`conductor`.`estado` = 'Activo') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `frag1documento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `frag1documento` AS select `documento`.`documentoId` AS `documentoId`,`documento`.`vehiculoId` AS `vehiculoId`,`documento`.`tipo` AS `tipo`,`documento`.`fechaVencimiento` AS `fechaVencimiento`,`documento`.`estado` AS `estado`,`documento`.`rutaArchivo` AS `rutaArchivo` from `documento` where (`documento`.`estado` = 'Vigente') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `frag1mantenimiento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `frag1mantenimiento` AS select `mantenimiento`.`mantenimientoId` AS `mantenimientoId`,`mantenimiento`.`vehiculoId` AS `vehiculoId`,`mantenimiento`.`fechaServicio` AS `fechaServicio`,`mantenimiento`.`tipoServicio` AS `tipoServicio`,`mantenimiento`.`descripcion` AS `descripcion`,`mantenimiento`.`costo` AS `costo`,`mantenimiento`.`estado` AS `estado` from `mantenimiento` where (`mantenimiento`.`costo` < 1500) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `frag1rutas`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `frag2conductor` AS select `conductor`.`conductorId` AS `conductorId`,`conductor`.`nombre` AS `nombre`,`conductor`.`numeroLicencia` AS `numeroLicencia`,`conductor`.`vencimientoLicencia` AS `vencimientoLicencia`,`conductor`.`estado` AS `estado` from `conductor` where (`conductor`.`estado` = 'Inactivo') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `frag2documento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `frag2documento` AS select `documento`.`documentoId` AS `documentoId`,`documento`.`vehiculoId` AS `vehiculoId`,`documento`.`tipo` AS `tipo`,`documento`.`fechaVencimiento` AS `fechaVencimiento`,`documento`.`estado` AS `estado`,`documento`.`rutaArchivo` AS `rutaArchivo` from `documento` where (`documento`.`estado` = 'Vencido') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `frag2mantenimiento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `frag2mantenimiento` AS select `mantenimiento`.`mantenimientoId` AS `mantenimientoId`,`mantenimiento`.`vehiculoId` AS `vehiculoId`,`mantenimiento`.`fechaServicio` AS `fechaServicio`,`mantenimiento`.`tipoServicio` AS `tipoServicio`,`mantenimiento`.`descripcion` AS `descripcion`,`mantenimiento`.`costo` AS `costo`,`mantenimiento`.`estado` AS `estado` from `mantenimiento` where (`mantenimiento`.`costo` >= 1500) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `frag2rutas`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `frag2rutas` AS select `ruta`.`rutaId` AS `rutaId`,`ruta`.`vehiculoId` AS `vehiculoId`,`ruta`.`conductorId` AS `conductorId`,`ruta`.`horaInicio` AS `horaInicio`,`ruta`.`horaFin` AS `horaFin`,`ruta`.`distancia` AS `distancia`,`ruta`.`ubicacionInicio` AS `ubicacionInicio`,`ruta`.`ubicacionFin` AS `ubicacionFin`,`ruta`.`estado` AS `estado` from `ruta` where (`ruta`.`distancia` <= 500) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `frag2vehiculo`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `frag2vehiculo` AS select `vehiculo`.`vehiculoId` AS `vehiculoId`,`vehiculo`.`flotillaId` AS `flotillaId`,`vehiculo`.`tipo` AS `tipo`,`vehiculo`.`modelo` AS `modelo`,`vehiculo`.`marca` AS `marca`,`vehiculo`.`anio` AS `anio`,`vehiculo`.`estado` AS `estado`,`vehiculo`.`fechaVerificacion` AS `fechaVerificacion` from `vehiculo` where (`vehiculo`.`anio` <= 2020) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `frag3documento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `frag3documento` AS select `documento`.`documentoId` AS `documentoId`,`documento`.`vehiculoId` AS `vehiculoId`,`documento`.`tipo` AS `tipo`,`documento`.`fechaVencimiento` AS `fechaVencimiento`,`documento`.`estado` AS `estado`,`documento`.`rutaArchivo` AS `rutaArchivo` from `documento` where (`documento`.`estado` = 'Por Vencer') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rutaconductor`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rutaconductor` AS select distinct `r`.`ubicacionInicio` AS `ubicacionInicio`,`r`.`ubicacionFin` AS `ubicacionFin`,`r`.`estado` AS `estado`,`r`.`distancia` AS `distancia`,`c`.`conductorId` AS `conductorId` from (`ruta` `r` join `conductor` `c` on((`c`.`conductorId` = `r`.`conductorId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rutavehiculo`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rutavehiculo` AS select distinct `r`.`ubicacionInicio` AS `ubicacionInicio`,`r`.`ubicacionFin` AS `ubicacionFin`,`r`.`estado` AS `estado`,`r`.`distancia` AS `distancia`,`v`.`modelo` AS `modelo` from (`ruta` `r` join `vehiculo` `v` on((`v`.`vehiculoId` = `r`.`vehiculoId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vehiculocombustible`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculocombustible` AS select distinct `c`.`tipoCombustible` AS `tipoCombustible`,`c`.`cantidad` AS `cantidad`,`c`.`monto` AS `monto`,`v`.`modelo` AS `modelo` from (`transaccioncombustible` `c` join `vehiculo` `v` on((`v`.`vehiculoId` = `c`.`vehiculoId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vehiculodocumento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculodocumento` AS select distinct `d`.`fechaVencimiento` AS `fechaVencimiento`,`d`.`tipo` AS `tipo`,`v`.`modelo` AS `modelo` from (`documento` `d` join `vehiculo` `v` on((`v`.`vehiculoId` = `d`.`vehiculoId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vehiculomantenimiento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculomantenimiento` AS select distinct `m`.`fechaServicio` AS `fechaServicio`,`m`.`descripcion` AS `descripcion`,`m`.`costo` AS `costo`,`v`.`modelo` AS `modelo` from (`mantenimiento` `m` join `vehiculo` `v` on((`v`.`vehiculoId` = `m`.`vehiculoId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-03-06 18:27:57
